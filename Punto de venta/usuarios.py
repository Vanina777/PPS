...
#Frame inferior
        ...
        btn_actualizar = Button(frame2, bg="#FFFFFF", fg="black", text="Actualizar Usuario", font="roboto 16 bold", command=self.actualizar_usuario_seleccionado)
...
#Funciones        
    ...
    def cargar_usuarios(self):
        ...
        for usuario in usuarios:
            ...
            self.lista_usuarios.insert("", "end", text=usuario[0], values=(usuario[1],usuario[2], usuario[3]))  # Mostrar asteriscos en lugar de la contraseña real
